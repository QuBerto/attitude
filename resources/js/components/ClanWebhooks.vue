            ...
            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                ...
                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    <button  type="button" class="text-gray-400 absolute top-2.5 right-2.5 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="deleteModal">
                        <svg  style="width:300px;" aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
...
export default {
    ...
    methods: {
        add() {
            ...
            axios.post(`${apiUrl}/api/clan-secret`, {
        ...
        remove() {
            const apiUrl = import.meta.env.VITE_APP_URL;
            axios.delete(`${apiUrl}/api/clan-secret/` + this.pendingDelete.id)
                .then((response) => {
                    this.toast.success(response.data.data);
                })
                .catch((error) => {
        ...
        getSecrets() {
            const apiUrl = import.meta.env.VITE_APP_URL;
            axios.get(`${apiUrl}/api/clan-secret/` + this.clanid)
                .then((response) => {
