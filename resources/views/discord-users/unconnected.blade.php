                    ...
                    <table class="min-w-full bg-white dark:bg-gray-800">
                        <thead class="bg-gray-800 text-white">
                            <tr>
                                ...
                                <th class="w-1/3 py-3 px-4 uppercase font-semibold text-sm hidden">Roles</th>
                            </tr>
                        </thead>
                        <tbody class="text-gray-700 dark:text-gray-300">
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td class="w-1/3 py-3 px-4 hidden">
                                        @foreach ($user->roles as $role)
                                            <span class="inline-block bg-gray-200 dark:bg-gray-700 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 dark:text-gray-300 mr-2">{{ $role->name }}</span>
                                        @endforeach
                                    </td>
                                </tr>
                            @endforeach
