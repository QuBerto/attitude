          ...
          <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div class="flex lg:flex-1">
              <a href="#" class="-m-1.5 p-1.5">
                ...
                <img class="h-8 w-auto" src="{{ asset('storage/assets/logo.gif') }}" alt="">
              </a>
            </div>
            ...
            <div class="hidden lg:flex lg:gap-x-12">
              <a href="#" class="text-sm font-semibold leading-6 text-gray-100">Events</a>
              <a href="#" class="text-sm font-semibold leading-6 text-gray-100">Members</a>
              <a href="#" class="text-sm font-semibold leading-6 text-gray-100">Kills</a>
              <a href="#" class="text-sm font-semibold leading-6 text-gray-100">Placeholder</a>
            </div>
            ...
            <div class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
              ...
              <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-gray-500/10">
                  ...
                  <div class="py-6">
                    <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-100 hover:bg-gray-50">Log in</a>
                  </div>
                </div>
              </div>
            </div>
...
{{-- 
    ...
    <main>
        ...
        src="{{ asset('storage/assets/logo.gif') }}" />
                        </div>
                        @if (Route::has('login'))
